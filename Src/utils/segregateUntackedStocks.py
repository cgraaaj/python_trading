...
with open(
    "/home/pudge/Trading/python_trading/Src/utils/pickle_data/untracked_stocks", "rb"
) as fp:
...
with open(
    "/home/pudge/Trading/python_trading/Src/utils/pickle_data/penny_stocks", "wb"
) as fp:
    pickle.dump(penny_stocks, fp)

print(len(untracked_small_cap_stocks))
with open(
    "/home/pudge/Trading/python_trading/Src/utils/pickle_data/untracked_small_cap_stocks",
    "wb",
) as fp:
